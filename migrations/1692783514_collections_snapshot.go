		...
		jsonData := `[
			{
				...
				"updated": "2023-08-21 21:55:30.152Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-08-21 21:55:30.153Z",
				"name": "saves",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-08-21 22:12:40.786Z",
				"name": "mods",
				"type": "base",
				"system": false,
				"schema": [
				...
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_YuR3e56` + "`" + ` ON ` + "`" + `mods` + "`" + ` (` + "`" + `title` + "`" + `)"
				],
				"listRule": "",
				"viewRule": "",
				"createRule": "@request.auth.id != \"\" && author = @request.auth.id",
			...
			},
			{
				...
				"updated": "2023-08-21 22:03:26.658Z",
				"name": "mod_versions",
				"type": "base",
				"system": false,
				"schema": [
				...
				"listRule": "",
				"viewRule": "",
				"createRule": "@collection.mods.id ?= @request.data.mod.id && @collection.mods.author ?= @request.auth.id",
